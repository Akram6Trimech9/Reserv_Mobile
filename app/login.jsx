        ...
        <ScreenWrapper bg="white">
            ...
            <View style={styles.container}>
                ...
                <View style={styles.form}>
                    ...
                    />
                   { passwordRef.current &&  <Text style={styles.showPasswordText} onPress={() => setShowPassword(prev => !prev)}>
                        {showPassword ? "Masquer le mot de passe" : "Afficher le mot de passe"}
                    </Text>}
                    <Text style={styles.forgotPassword}  onPress={()=> router.push('forgetPassword')}>
                       Mot de passe oublié ? 
                    </Text>
                ...
                <View style={styles.footer}>
                    ...
                    <Pressable onPress={()=> router.push('signUp')}>
                         <Text style={[styles.footerText, {color: theme.colors.green, fontWeight: theme.fonts.semibold}]}>Inscription</Text>
                    </Pressable>
                </View>
            </View>
        </ScreenWrapper>
